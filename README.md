...
├── project/              Project planning, dashboards, and generated views
│   ├── dashboard.html    HTML tracker dashboard
│   ├── changes.html      Overall project change overview
│   └── site/             Compatibility copy of the project overview
...
## Live archive dashboard and change history

The generated public views are available through GitHub Pages after the relevant
changes are merged and Pages finishes deploying:

- [Tracking dashboard](https://myndiswiki.github.io/MyNDIS/project/dashboard.html)
  shows every tracked project, its status, last check, page count, change counts,
  and issues needing attention such as capture errors or robots exclusions.
- [Overall change overview](https://myndiswiki.github.io/MyNDIS/project/changes.html)
  lists each project with recorded changes and links to its separate history page.
- Each project has its own detailed `changes.html` page under `archive/`. These
  pages show the recorded change information inline in expandable sections and
  link to the full changelog.

### Live project change pages

- [NDIS website](https://myndiswiki.github.io/MyNDIS/archive/ndis/changes.html)
- [NDIS data and research](https://myndiswiki.github.io/MyNDIS/archive/dataresearch/changes.html)
- [APH](https://myndiswiki.github.io/MyNDIS/archive/reports/aph/changes.html)
- [Engage NDIS](https://myndiswiki.github.io/MyNDIS/archive/reports/engage-ndis/changes.html)
- [Health NDIS](https://myndiswiki.github.io/MyNDIS/archive/reports/health/changes.html)
- [NDIA](https://myndiswiki.github.io/MyNDIS/archive/reports/ndia/changes.html)
- [NDIS Commission](https://myndiswiki.github.io/MyNDIS/archive/reports/ndis-commission/changes.html)
- [NDIS Review](https://myndiswiki.github.io/MyNDIS/archive/reports/ndis-review/changes.html)
- [Victorian Government](https://myndiswiki.github.io/MyNDIS/archive/reports/vic-gov/changes.html)

The dashboard is generated by `project/build_dashboard.py`. The overview and
per-project pages are generated by `project/build_change_pages.py`. The
`Build change history pages` workflow rebuilds these views when archive ledgers
or their builders change. The dashboard also writes machine-readable data to
`archive/reports/dashboard.json` and a Markdown summary to
